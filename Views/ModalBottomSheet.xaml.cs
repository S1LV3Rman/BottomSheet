...
{    
    public partial class ModalBottomSheet : ContentView
    {
        ...
        private double MinimizedHeight => ContentHeight > 0d ?
            Math.Min(_pageHeight * MAX_MINIMIZED_SIZE, ContentHeight + Padding.VerticalThickness) :
        ...
        private const double EMPTY_HEIGHT = 50d;
        ...
        private void Init()
        {
            ...
            var size = Content.Measure(_pageWidth, PageHeight);

            if (size.Minimum.Height > 0d && ContentHeight <= 0d)
                return;
